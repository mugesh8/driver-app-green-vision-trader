...
export default function LocalOrderView() {
  const navigate = useNavigate();
  const { stage1Orders = [], localOrders = [], loading, error, updateStage1 } = useDriverOrders();
  ...
  const allOrders = [...stage1Orders, ...localOrders];
    ...
    <div className="px-4 py-4 space-y-4">
      ...
      {loading ? (
        ...
        <p className="text-[#A0A0A0] text-center py-12">
          No local pickup orders assigned. Pull down to refresh.
        </p>
      ) : (
